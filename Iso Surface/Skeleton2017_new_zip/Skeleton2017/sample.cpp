...
void contour_calculationXY(int i, int j, int k)
{
	...
	s1= grid_3d[i][j][k].T; // grid_pts[(i*NX) + j]
	s2= grid_3d[i + 1][j][k].T; //grid_pts[(i*NX) + j +1]
	s3= grid_3d[i + 1][j + 1][k].T; //grid_pts[(i*NX) + j + 1 + NX]
	s4 = grid_3d[i][j + 1][k].T ; //grid_pts[(i*NX) + j + NX]

	// ****************************
	// grid_3d[i][j][k] // grid_pts[(i*NX) + j]
	// grid_3d[i + 1][j][k] //grid_pts[(i*NX) + j +1]
	// grid_3d[i + 1][j + 1][k] //grid_pts[(i*NX) + j + 1 + NX]
	// grid_3d[i][j + 1][k] //grid_pts[(i*NX) + j + NX]
	// ******************************
...
void contour_calculationYZ(int i, int j, int k)
{
	...
	s1 = grid_3d[i][j][k].T; // grid_pts[(i*NX) + j]
	s2 = grid_3d[i][j+1][k].T; //grid_pts[(i*NX) + j +1]
	s3 = grid_3d[i][j + 1][k+1].T; //grid_pts[(i*NX) + j + 1 + NX]
	s4 = grid_3d[i][j][k+1].T; //grid_pts[(i*NX) + j + NX]
...
void contour_calculationZX(int i, int j, int k)
{
	...
	s1 = grid_3d[i][j][k].T; // grid_pts[(i*NX) + j]
	s2 = grid_3d[i + 1][j][k].T; //grid_pts[(i*NX) + j +1]
	s3 = grid_3d[i + 1][j][k+1].T; //grid_pts[(i*NX) + j + 1 + NX]
	s4 = grid_3d[i][j][k+1].T; //grid_pts[(i*NX) + j + NX]
